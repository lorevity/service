...
# Usage
It's preferred to use the [darklua](https://github.com/lorevity/darklua) tool while working with this utility, but as an exception there is a [build version](https://github.com/lorevity/service/releases/download/0.0.1/service.luau). <br />
